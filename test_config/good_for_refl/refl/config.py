...
def get_beamline():
    ...
    comps = [s1, theta, s3, detector, s4_comp, not_in_mode]
    ...
    params_all = [slit1_pos, s3_enabled, theta_ang, slit3_pos, detector_position, detector_angle, not_in_mode_pos, hgap_param, slit4_pos]
    params_default = [slit1_pos, s3_enabled, theta_ang, slit3_pos, detector_position, detector_angle, slit4_pos]
