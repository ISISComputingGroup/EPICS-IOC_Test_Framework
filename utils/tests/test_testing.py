...
class ParameterizedListTests(unittest.TestCase):
    ...
    def test_that_GIVEN_a_list_of_tuples_with_two_objects_THEN_a_list_of_extended_tuples_is_returned(
        self,
    ):
        # Given:
    ...
    def test_that_GIVEN_a_list_of_tuples_with_three_objects_THEN_a_list_of_extended_tuples_is_returned(
        self,
    ):
        # Given:
