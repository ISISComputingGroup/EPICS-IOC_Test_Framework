...
class TestEmulatorLauncher(unittest.TestCase):
    def test_that_GIVEN_a_commandline_emulator_opens_THEN_it_closes_properly(self):
        emulator = CommandLineEmulatorLauncher(
            "test_that_GIVEN_a_commandline_emulator_opens_THEN_it_closes_properly",
    ...
    def test_that_GIVEN_a_commandline_emulator_opens_AND_has_child_proceses_THEN_all_closes_properly(
        self,
    ):
        emulator = CommandLineEmulatorLauncher(
            "test_that_GIVEN_a_commandline_emulator_opens_THEN_it_closes_properly",
    ...
    def test_that_GIVEN_a_commandline_emulator_opens_AND_has_nested_child_proceses_THEN_all_closes_properly(
        self,
    ):
        emulator = CommandLineEmulatorLauncher(
            "test_that_GIVEN_a_commandline_emulator_opens_THEN_it_closes_properly",
