...
class HfmagpsuTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._rampTargets = ['ZERO', 'MID', 'MAX']
        self._directions = ['-', '0', '+']
    ...
    def _write_max_target(self, maxT):
        self.ca.set_pv_value("HFMAGPSU_01:LOGMESSAGE", "HH:MM:SS MAX SETTING: [" + str(maxT) + "]")
        self.ca.set_pv_value("HFMAGPSU_01:MAX:SP", maxT)
    ...
    def test_GIVEN_direction_set_WHEN_read_THEN_direction_is_as_expected(self):
        expected_direction = self._directions[2]
        self._write_direction(2)
        self.ca.assert_that_pv_is("HFMAGPSU_01:DIRECTION", expected_direction)

    def test_GIVEN_direction_set_again_WHEN_read_THEN_direction_is_as_expected(self):
        expected_direction = self._directions[0]
        self._write_direction(0)
        self.ca.assert_that_pv_is("HFMAGPSU_01:DIRECTION", expected_direction)
