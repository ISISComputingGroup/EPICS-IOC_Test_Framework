...
class HfmagpsuTests(unittest.TestCase):
    ...
    def test_GIVEN_outputMode_set_WHEN_read_THEN_outputMode_is_as_expected(self):
        expected_mode = 'O'
        self.ca.set_pv_value("HFMAGPSU_01:OUTPUTMODE", expected_mode)
        self.ca.assert_that_pv_is("HFMAGPSU_01:OUTPUTMODE", expected_mode)
    ...
    def test_GIVEN_pause_set_WHEN_read_THEN_pause_is_as_expected(self):
        expected_output = 'ON'
        self._write_pause(expected_output)
    ...
    def test_GIVEN_update_read(self):
        expected_output = "........ FIELD CONSTANT: 456.789 T\r\n" + \
                  "........ HEATER OUTPUT: 2.2 VOLTS\r\n" + \
                "........ VOLTAGE LIMIT: 50.0 VOLTS\r\n" + \
                "........ RAMP RATE: 1.2 A/SEC"
        self.ca.assert_that_pv_is("HFMAGPSU_01:UPDATE", expected_output)