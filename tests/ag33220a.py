...
class Ag33220aTests(unittest.TestCase):
    ...
    def reset_values(self):
        ...
        self.ca.set_pv_value("AG33220A_01:FREQUENCY:SP", 1000.0)
        self.ca.set_pv_value("AG33220A_01:OFFSET:SP", 0.0)
        self.ca.set_pv_value("AG33220A_01:FUNCTION:SP", "SIN")

    def test_WHEN_amplitude_change_to_5_THEN_readback_is_5(self):
        self.ca.set_pv_value("AG33220A_01:AMPLITUDE:SP", 5.0)
    ...
    def test_WHEN_frequency_is_set_higher_than_allowed_THEN_it_is_limited(self):
        self.ca.set_pv_value("AG33220A_01:FREQUENCY:SP", 1.0*10**8)
        self.ca.assert_that_pv_is("AG33220A_01:FREQUENCY", 2.0*10**7)
    ...
    def test_WHEN_volt_high_is_set_lower_than_volt_low_THEN_volt_low_is_reduced(self):
        self.ca.set_pv_value("AG33220A_01:VOLT:HIGH:SP", 1.0)
        self.ca.set_pv_value("AG33220A_01:VOLT:LOW:SP", -1.0)
        self.ca.set_pv_value("AG33220A_01:VOLT:HIGH:SP", -2.0)
        self.ca.assert_that_pv_is("AG33220A_01:VOLT:HIGH", -2.0)
    ...
    def test_WHEN_change_in_volt_low_to_below_range_THEN_value_is_limited(self):
        self.ca.set_pv_value("AG33220A_01:VOLT:LOW:SP", -10.0)
        self.ca.set_pv_value("AG33220A_01:VOLT:HIGH:SP", 0.0)
        self.ca.assert_that_pv_is("AG33220A_01:VOLT:LOW", -5.0)
        self.ca.assert_that_pv_is("AG33220A_01:AMPLITUDE", 5.0)
    ...
    def test_WHEN_offset_set_to_2_and_half_and_amplitude_to_5_THEN_volt_high_is_5_and_volt_low_is_0(self):
        ...
        self.ca.set_pv_value("AG33220A_01:AMPLITUDE:SP", 5.0)
        self.ca.assert_that_pv_is("AG33220A_01:VOLT:HIGH", 5.0)
        self.ca.assert_that_pv_is("AG33220A_01:VOLT:LOW", 0.0)

    @skipIf(IOCRegister.uses_rec_sim, "In rec sim this test fails")
    def test_WHEN_offset_set_to_0_and_2_THEN_volt_low_is_neg_1_and_high_is_1(self):
        self.ca.set_pv_value("AG33220A_01:OFFSET:SP", 0.0)
        self.ca.set_pv_value("AG33220A_01:AMPLITUDE:SP", 2.0)
        self.ca.assert_that_pv_is("AG33220A_01:VOLT:HIGH", 1.0)
        self.ca.assert_that_pv_is("AG33220A_01:VOLT:LOW", -1.0)

    @skipIf(IOCRegister.uses_rec_sim, "In rec sim this test fails")
    def test_WHEN_amplitude_set_to_less_than_min_THEN_amplitude_is_limited(self):
        self.ca.set_pv_value("AG33220A_01:AMPLITUDE:SP", 0.0)
        self.ca.assert_that_pv_is("AG33220A_01:AMPLITUDE", 0.01)

    @skipIf(IOCRegister.uses_rec_sim, "In rec sim this test fails")
    def test_WHEN_offset_changed_to_cause_voltage_larger_than_max_THEN_amplitude_reduced(self):
        self.ca.set_pv_value("AG33220A_01:OFFSET:SP", 0.0)
        self.ca.set_pv_value("AG33220A_01:AMPLITUDE:SP", 6.0)

        self.ca.set_pv_value("AG33220A_01:OFFSET:SP", 3.0)

        self.ca.assert_that_pv_is("AG33220A_01:OFFSET", 3.0)
        self.ca.assert_that_pv_is("AG33220A_01:AMPLITUDE", 4.0)
        self.ca.assert_that_pv_is("AG33220A_01:VOLT:LOW", 1.0)
        self.ca.assert_that_pv_is("AG33220A_01:VOLT:HIGH", 5.0)
    ...
    def test_WHEN_amplitude_changed_to_cause_voltage_larger_than_max_THEN_offset_reduced(self):
        ...
        self.ca.assert_that_pv_is("AG33220A_01:OFFSET", 2.0)
        self.ca.assert_that_pv_is("AG33220A_01:AMPLITUDE", 6.0)
        self.ca.assert_that_pv_is("AG33220A_01:VOLT:LOW", -1.0)
        self.ca.assert_that_pv_is("AG33220A_01:VOLT:HIGH", 5.0)
