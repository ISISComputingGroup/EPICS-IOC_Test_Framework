...
VALVE_STATUS_PVS = ["MOTORISED_VALVE_108:STATUS", "CNTRL_VALVE_112:STATUS", "CNTRL_VALVE_2150:STATUS",
                    "CNTRL_VALVE_2160:STATUS", "CNTRL_VALVE_2250:STATUS", "MOTORISED_VALVE_110:STATUS",
                    "MOTORISED_VALVE_160:STATUS", "MOTORISED_VALVE_163:STATUS", "MOTORISED_VALVE_167:STATUS",
                    "MOTORISED_VALVE_172:STATUS", "MOTORISED_VALVE_174:STATUS", "MOTORISED_VALVE_175:STATUS",
                    "MOTORISED_VALVE_176:STATUS", "MOTORISED_VALVE_177:STATUS", "MOTORISED_VALVE_178:STATUS",
                    "CNTRL_VALVE_103:STATUS", "CNTRL_VALVE_111:STATUS"]
...
LIQUEFIER_ALARMS = ["POWER_FAILURE", "TURBINE1:BRAKE_TEMP", "TURBINE2:BRAKE_TEMP", "TURBINE1:OVERSPEED",
                    ...
                    "TURBINE:UNDERCOOL", "TURBINE:MALFUNCTION", "PURIFIER:UNDERCOOL", "LIS107",
                    "PLANT_AUTOSTOP:TIMEOUT", "EMERGENCY_STOP", "230VAC:FUSE", "24VDC:FUSE", "LTX107:FUSE",
                    "SAFTY_CHAIN_TURBINE", "PSL2951", "FI3100:COOLING"]
...
class HeliumRecoveryPLCTests(unittest.TestCase):
    ...
    @parameterized.expand(parameterized_list(zip(INT16_PV_NAMES, INT16_TEST_VALUES)))
    @skip_if_recsim("lewis backdoor not supported in recsim")
    def test_WHEN_int16_value_set_negative_value_backdoor_THEN_ioc_read_correctly(self, _, pv_name, test_value):
        self._lewis.backdoor_run_function_on_device("set_memory", (pv_name, -test_value))
        self.ca.process_pv("{}:_RAW".format(pv_name))
        self.ca.assert_that_pv_is(pv_name, -test_value / 10)
    ...
    @parameterized.expand(parameterized_list(zip(INT16_PV_NAMES, INT16_TEST_VALUES)))
    @skip_if_devsim("sim pvs not available in devsim")
    def test_WHEN_int16_value_set_negative_value_sim_pv_THEN_ioc_read_correctly(self, _, pv_name, test_value):
        self.ca.set_pv_value("SIM:{}".format(pv_name), -test_value)
        self.ca.process_pv("{}:_RAW".format(pv_name))
        self.ca.assert_that_pv_is(pv_name, -test_value / 10)
