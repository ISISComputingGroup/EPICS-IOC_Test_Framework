...
PV_NAMESS = ["HEARTBEAT", "MCP:BANK1:TS2", "MCP:BANK1:TS1", "MCP1:BANK2:IMPURE_HE", "MCP2:BANK2:IMPURE_HE",
            ...
            "MCP:EXTERNAL_TEMP", "GAS_LIQUEFACTION:MASS_FLOW", "HE_FILLS:MASS_FLOW", "COMPRESSOR:INTERNAL_TEMP",
            ...
            "BANK5:SPARE_STORA:AVG_PURITY", "BANK6:SPARE_STORA:AVG_PURITY", "BANK7:SPARE_STORA:AVG_PURITY",
...
PV_NAMES = ["GAS_LIQUEFACTION:MASS_FLOW", "HE_FILLS:MASS_FLOW", "FLOW_METER:TS2:EAST", "FLOW_METER:TS2:WEST",
            "FLOW_METER:TS1:WINDOW", "FLOW_METER:TS1:SHUTTER", "FLOW_METER:TS1:VOID"]
