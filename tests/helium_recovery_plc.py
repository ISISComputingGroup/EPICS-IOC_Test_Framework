...
PV_NAMES_FULL = ["HEARTBEAT", "MCP:BANK1:TS2", "MCP:BANK1:TS1", "MCP1:BANK2:IMPURE_HE", "MCP2:BANK2:IMPURE_HE",
            ...
            "TS1:WINDOW:FLOW_METER", "TS1:SHUTTER:FLOW_METER", "TS1:VOID:FLOW_METER"]

PV_NAMESA = ["GC:R108:U40", "GC:R108:DEWAR_FARM", "GC:R55:TOTAL", "GC:R55:NORTH", "GC:R55:SOUTH", "GC:MICE_HALL"
            "GC:MUON", "GC:PEARL_HRPD_MARI_ENGINX", "GC:SXD_AND_MERLIN", "GC:CRYO_LAB", "GC:MAPS_AND_VESUVIO",
            "GC:SANDALS", "GC:CRISP_AND_LOQ", "GC:IRIS_AND_OSIRIS"]

PV_NAMES = ["GC:R108:U40"]
