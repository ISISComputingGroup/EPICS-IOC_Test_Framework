...
class Lakeshore460Tests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ca = ChannelAccess(
            device_prefix="LKSH460_01", default_timeout=30, default_wait_time=0.0
        )
        self.ca.assert_that_pv_exists("IDN")

    @parameterized.expand(
        [
            ("tesla", UnitFlags.TESLA, UnitStrings.TESLA),
    ...
    @parameterized.expand(
        [("DC", UnitFlags.DC, UnitStrings.DC), ("AC", UnitFlags.AC, UnitStrings.AC)]
    )
    @skip_if_recsim("In rec sim this test fails")
