...
class TtiplpTests(unittest.TestCase):
    ...
    def set_init_state(
        self, volt_sp=0.0, curr_sp=0.0, ov_volt_sp=0.0, ov_curr_sp=0.0, output="Off"
    ):
    ...
    def test_GIVEN_overvolt_and_overcurrent_more_than_output_current_and_output_voltage_WHEN_output_set_THEN_output_readback_updates(
        self,
    ):
    ...
    def test_GIVEN_overvolt_and_overcurrent_more_than_output_current_and_output_voltage_WHEN_overvolt_set_less_than_output_voltage_THEN_output_readback_turns_off(
        self,
    ):
    ...
    @skip_if_recsim("Behaviour not modelled in recsim")
    def test_GIVEN_overvolt_and_overcurrent_more_than_output_current_and_output_voltage_WHEN_overcurrent_set_less_than_output_current_THEN_output_readback_turns_off(
        self,
    ):
    ...
    @skip_if_recsim("Behaviour not modelled in recsim")
    def test_GIVEN_overvolt_and_overcurrent_less_than_output_current_and_output_voltage_WHEN_output_set_to_on_THEN_output_readback_stays_off(
        self,
    ):
    ...
    def test_GIVEN_normal_operation_THEN_limit_event_staus_bits_are_not_set(self):
        self.set_init_state(volt_sp=10.0, curr_sp=1.0, ov_volt_sp=15.0, ov_curr_sp=2.0, output="On")

        self.ca.assert_that_pv_is("OVERCURR:STAT", "Ok")
        self.ca.assert_that_pv_is("OVERVOLT:STAT", "Ok")

    @skip_if_recsim("Behaviour not modelled in recsim")
    def test_WHEN_voltage_higher_than_overvolt_protection_limit_THEN_overvolt_status_set_to_tripped(
        self,
    ):
        self.set_init_state(volt_sp=10.0, curr_sp=1.0, ov_volt_sp=5.0, ov_curr_sp=2.0, output="On")

        self.ca.assert_that_pv_is("OVERCURR:STAT", "Ok")
        self.ca.assert_that_pv_is("OVERVOLT:STAT", "Tripped")

    @skip_if_recsim("Behaviour not modelled in recsim")
    def test_WHEN_current_higher_than_overcurr_protection_limit_THEN_overcurr_status_set_to_tripped(
        self,
    ):
        self.set_init_state(volt_sp=10.0, curr_sp=2.0, ov_volt_sp=20.0, ov_curr_sp=1, output="On")

        self.ca.assert_that_pv_is("OVERCURR:STAT", "Tripped")
        self.ca.assert_that_pv_is("OVERVOLT:STAT", "Ok")

    @skip_if_recsim("Behaviour not modelled in recsim")
    def test_WHEN_current_and_voltage_higher_than_protection_limits_THEN_both_statuses_set_to_tripped(
        self,
    ):
        self.set_init_state(volt_sp=10.0, curr_sp=2.0, ov_volt_sp=5.0, ov_curr_sp=1, output="On")
    ...
    def test_GIVEN_overcurr_tripped_WHEN_triprst_called_THEN_overcurr_ok(self):
        self.set_init_state(volt_sp=10.0, curr_sp=3.0, ov_volt_sp=15.0, ov_curr_sp=2.0, output="On")
