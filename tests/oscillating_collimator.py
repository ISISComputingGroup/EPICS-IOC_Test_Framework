...
class Oscillating_collimatorTests(unittest.TestCase):
    ...
    def test_WHEN_mounting_radius_set_negative_THEN_mounting_radius_is_zero(self):
        self.ca.set_pv_value(RADIUS, -1.0, wait=False)
