...
class NimatroTests(unittest.TestCase):
    ...
    @parameterized.expand([('low limit', 36), ('random1', 93), ('random2', 230), ('high limit', 247)])
    ...
    def test_GIVEN_running_ioc_WHEN_set_invalid_target_area_sp_THEN_record_bounded(self, _, area):
        ...
        self.ca.assert_that_pv_is_within_range("AREA:TARGET:SP:RBV", 36, 247)

    @parameterized.expand([('low limit', -75.0), ('random1', 10.0), ('random2', 34.2), ('high limit', 75.0)])
    ...
    def test_GIVEN_running_ioc_WHEN_set_invalid_target_pressure_sp_THEN_record_bounded(self, _, pressure):
        ...
        self.ca.assert_that_pv_is_within_range("PRESSURE:TARGET:SP:RBV", -75, 75)

    @parameterized.expand([('low limit', -174.2), ('random1', -23.5), ('random2', 34.2), ('high limit', 174.2)])
