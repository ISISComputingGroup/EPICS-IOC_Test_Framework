...
class NimatroTests(unittest.TestCase):
    ...
    @parameterized.expand([('low limit', AREA_DEFAULT_LOW_LIMIT), ('test_value_1', 93), ('test_value_2', 230), ('high limit', AREA_DEFAULT_HIGH_LIMIT)])
    ...
    @parameterized.expand([('low limit check', AREA_DEFAULT_LOW_LIMIT - 1), ('high limit check', AREA_DEFAULT_HIGH_LIMIT + 1)])
    def test_GIVEN_running_ioc_WHEN_set_invalid_target_area_sp_THEN_record_bounded(self, _, area):
        expected_value = area
        self.ca.set_pv_value("AREA:SP", expected_value)

        self.ca.assert_that_pv_is_within_range("AREA:SP:RBV", AREA_DEFAULT_LOW_LIMIT, AREA_DEFAULT_HIGH_LIMIT)

    @parameterized.expand([("high_limit_check", AREA_DEFAULT_LOW_LIMIT, AREA_DEFAULT_HIGH_LIMIT, AREA_DEFAULT_HIGH_LIMIT + 1), 
                           ("low_limit_check", AREA_DEFAULT_LOW_LIMIT, AREA_DEFAULT_HIGH_LIMIT, AREA_DEFAULT_LOW_LIMIT - 1), 
                           ("within_range_test", AREA_DEFAULT_LOW_LIMIT, AREA_DEFAULT_HIGH_LIMIT, AREA_DEFAULT_HIGH_LIMIT - 1)])
    def test_GIVEN_area_limits_explicitly_provided_WHEN_area_sp_written_THEN_sp_is_coerced_into_limits(self, _, low_limit, high_limit, expected_value):
        with self._ioc.start_with_macros({"AREA_HIGH_LIMIT": high_limit, "AREA_LOW_LIMIT": low_limit}, pv_to_wait_for="DISABLE"):
            self.ca.set_pv_value("AREA:SP", expected_value)
    ...
    @parameterized.expand([("high_limit_check", PR_DEFAULT_LOW_LIMIT, PR_DEFAULT_HIGH_LIMIT, PR_DEFAULT_HIGH_LIMIT + 1), 
                           ("low_limit_check", PR_DEFAULT_LOW_LIMIT, PR_DEFAULT_HIGH_LIMIT, PR_DEFAULT_LOW_LIMIT - 1), 
                           ("with_range_test", PR_DEFAULT_LOW_LIMIT, PR_DEFAULT_HIGH_LIMIT, PR_DEFAULT_HIGH_LIMIT - 1)])
    def test_GIVEN_pressure_limits_explicitly_provided_WHEN_pressure_sp_written_THEN_sp_is_coerced_into_limits(self, _, low_limit, high_limit, expected_value):
        with self._ioc.start_with_macros({"PRESSURE_HIGH_LIMIT": high_limit, "PRESSURE_LOW_LIMIT": low_limit}, pv_to_wait_for="DISABLE"):
    ...
    @parameterized.expand([("high_limit_check", SPEED_DEFAULT_LOW_LIMIT, SPEED_DEFAULT_HIGH_LIMIT, SPEED_DEFAULT_HIGH_LIMIT + 1), 
                           ("low_limit_check", SPEED_DEFAULT_LOW_LIMIT, SPEED_DEFAULT_HIGH_LIMIT, SPEED_DEFAULT_LOW_LIMIT - 1), 
                           ("with_range_test", SPEED_DEFAULT_LOW_LIMIT, SPEED_DEFAULT_HIGH_LIMIT, SPEED_DEFAULT_HIGH_LIMIT - 1)])
    def test_GIVEN_speed_limits_explicitly_provided_WHEN_speed_sp_written_THEN_sp_is_coerced_into_limits(self, _, low_limit, high_limit, expected_value):
        with self._ioc.start_with_macros({"SPEED_HIGH_LIMIT": high_limit, "SPEED_LOW_LIMIT": low_limit}, pv_to_wait_for="DISABLE"):
