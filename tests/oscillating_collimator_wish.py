...
class OscillatingCollimatorTests(OscillatingCollimatorBase, unittest.TestCase):
    ...
    @parameterized.expand([[0.4, 5000, 2500], [0.2, 10000, 800]])
    def test_GIVEN_number_of_cycles_to_maintenance_rotation_THEN_time_to_maintenance_cycle_is_correct(
        self, freq, mnt_cycles, current_cycle
    ):
