...
class MotionSetpointsTests(unittest.TestCase):
    ...
    def test_GIVEN_2D_WHEN_move_motor_THEN_tolerance_checked(self):
        ...
        self.ca2DAxis.set_pv_value("POSN:SP", POSITION_SAMPLE2)
        self.motor_ca.assert_that_pv_is("MTR0.RBV", MOTOR_POSITION_SAMPLE2_COORD1)
        self.ca2DAxis.assert_that_pv_is("POSN", POSITION_SAMPLE2)
        self.ca2DAxis.assert_that_pv_is("IPOSN", 1)
        """move motor, all should still be OK as within tolerance"""
        self.motor_ca.set_pv_value("MTR0", MOTOR_POSITION_SAMPLE2_COORD1 - 0.2)
        self.motor_ca.assert_that_pv_is("MTR0.RBV", MOTOR_POSITION_SAMPLE2_COORD1 - 0.2)
        self.ca2DAxis.assert_that_pv_is("POSN", POSITION_SAMPLE2)
        self.ca2DAxis.assert_that_pv_is("IPOSN", 1)
        self.ca2DAxis.assert_that_pv_is("POSITIONED", 1)
        """change tolerance, should not be in position"""
        self.ca2DAxis.set_pv_value("TOLERENCE", 0.1)
        self.ca2DAxis.assert_that_pv_is("POSN", "")
        self.ca2DAxis.assert_that_pv_is("IPOSN", -1)
        self.ca2DAxis.assert_that_pv_is("POSITIONED", 0)
        """move motor back, should now be in position again"""
        self.motor_ca.set_pv_value("MTR0", MOTOR_POSITION_SAMPLE2_COORD1)
        self.motor_ca.assert_that_pv_is("MTR0.RBV", MOTOR_POSITION_SAMPLE2_COORD1)
        self.ca2DAxis.assert_that_pv_is("POSN", POSITION_SAMPLE2)
        self.ca2DAxis.assert_that_pv_is("IPOSN", 1)
        self.ca2DAxis.assert_that_pv_is("POSITIONED", 1)
