...
class FermichopperTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if not IOCRegister.uses_rec_sim:
            ...
            self.ca.assert_that_pv_is("DELAY", 0)
            self.ca.assert_that_pv_is("DELAY:SP:RBV", 0)
    ...
    def _lie_about_delay_setpoint_readback(self):
        ...
        self._lewis.backdoor_set_on_device("is_lying_about_delay_sp_rbv", True)
        try:
            yield
        finally:
            self._lewis.backdoor_set_on_device("is_lying_about_delay_sp_rbv", False)
    ...
    def _lie_about_gatewidth(self):
        ...
        self._lewis.backdoor_set_on_device("is_lying_about_gatewidth", True)
        try:
            yield
        finally:
            self._lewis.backdoor_set_on_device("is_lying_about_gatewidth", False)
    ...
    def test_GIVEN_setpoint_is_already_at_600Hz_WHEN_setting_setpoint_to_600Hz_THEN_device_does_not_break(self):
        ...
        self.assertFalse(self.is_device_broken())
